	...
	public function widget( $args, $instance ) {
		...
		foreach($cat_arr as $cat)
		{
			...
			if($cat['Type']=="Normal")
			{
				...
				{
				array_push($cat_id_arr_normal,$cat['CategoryId']);
		...
		if(!empty($cat_id_arr_normal) && !empty($cat_id_arr_special) )
		{
		$video_id_arr = array();
		$cat_esist = 0;
		...
		{
			echo "You must select normal and special category.";
		}
